...
import net.seanomik.tamablefoxes.versions.version_1_18_R2.pathfinding.*;
...
public class EntityTamableFox extends Fox {
    ...
    public void registerGoals() {
        try {
            ...
            Field landTargetGoal = this.getClass().getSuperclass().getDeclaredField("cm"); // landTargetGoal
            ...
            Field turtleEggTargetGoal = this.getClass().getSuperclass().getDeclaredField("cn"); // turtleEggTargetGoal
            ...
            Field fishTargetGoal = this.getClass().getSuperclass().getDeclaredField("co"); // fishTargetGoal
    ...
    protected EntityDataAccessor<Byte> getDataFlagsId() throws NoSuchFieldException, IllegalAccessException {
        Field dataFlagsField = Fox.class.getDeclaredField("ca"); // DATA_FLAGS_ID
