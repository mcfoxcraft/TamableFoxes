package net.seanomik.tamablefoxes.versions.version_1_18_1_R1;
...
import net.seanomik.tamablefoxes.versions.version_1_18_1_R1.pathfinding.*;
...
public class EntityTamableFox extends Fox {
    ...
    public void registerGoals() {
        try {
            ...
            Field landTargetGoal = this.getClass().getSuperclass().getDeclaredField("cn"); // landTargetGoal
            ...
            Field turtleEggTargetGoal = this.getClass().getSuperclass().getDeclaredField("co"); // turtleEggTargetGoal
            ...
            Field fishTargetGoal = this.getClass().getSuperclass().getDeclaredField("cp"); // fishTargetGoal
