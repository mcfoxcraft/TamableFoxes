package net.seanomik.tamablefoxes.versions.version_1_19_R3;
...
import net.seanomik.tamablefoxes.versions.version_1_19_R3.pathfinding.*;
...
public class EntityTamableFox extends Fox {
    ...
    protected EntityDataAccessor<Byte> getDataFlagsId() throws NoSuchFieldException, IllegalAccessException {
        Field dataFlagsField = Fox.class.getDeclaredField("bX"); // DATA_FLAGS_ID
